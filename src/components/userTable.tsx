...
export const columns = [
  ...
  {name: "STATUS", uid: "status", sortable: true}, // jai wela majech
...
export const statusOptions = [
  {name: "Start Work", uid: "Start"},
  {name: "Still absent", uid: "still"},
];
          ...
          <div className="relative flex justify-center items-center gap-2">
            <Dropdown>
              <DropdownTrigger>
                ...
                <FaEllipsisVertical size={18} className="text-[#004838] "/>
                </Button>
              </DropdownTrigger>
              <DropdownMenu>
